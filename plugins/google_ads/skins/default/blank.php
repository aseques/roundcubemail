...
<body style="background-color:#F2F2F2;" onload="parent.focus()">
...
$credentials = $rcmail_config['google_ads_blank']['default'];
if($_SERVER['HTTPS']){
  $https = 's';
}
else{
...
<img src="images/watermark.gif" width="240" height="228" alt="" />
</div>
